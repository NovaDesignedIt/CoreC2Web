...
(function(APILoadingStatus2) {
  APILoadingStatus2["NOT_LOADED"] = "NOT_LOADED";
  APILoadingStatus2["LOADING"] = "LOADING";
  APILoadingStatus2["LOADED"] = "LOADED";
  APILoadingStatus2["FAILED"] = "FAILED";
...
function useGoogleMapsApiLoader(props) {
  ...
  const [status, setStatus] = (0, import_react.useState)(NOT_LOADED);
...
var useMap = (id = null) => {
  const {
    mapInstances = {}
  } = (0, import_react.useContext)(APIProviderContext) || {};
  const {
    map
...
function useMarker(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (onDrag)
      m.addListener("drag", onDrag);
    if (onDragStart)
      m.addListener("dragstart", onDragStart);
    if (onDragEnd)
      m.addListener("dragend", onDragEnd);
    if (onMouseOver)
      m.addListener("mouseover", onMouseOver);
    if (onMouseOut)
      m.addListener("mouseout", onMouseOut);
