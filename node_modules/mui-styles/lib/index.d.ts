...
type BaseCreateCSSProperties<Props extends object = {}> = {
    [P in keyof BaseCSSProperties]: keyof Props extends {} ? BaseCSSProperties[P] : BaseCSSProperties[P] | PropsFunc<Props, BaseCSSProperties[P]>;
};
...
interface WithStylesOptions<Theme = Theme$1> extends StyleSheetFactoryOptions {
    defaultTheme?: Theme;
    flip?: boolean;
    withTheme?: boolean;
    name?: string;
...
declare function makeStyles$1<Theme = Theme$1, Props extends object = {}, ClassKey extends string = string>(stylesOrCreator: Styles<Theme, Props, ClassKey>, options?: Omit<WithStylesOptions<Theme>, "withTheme"> | any): keyof Props extends never ? (props?: any) => ClassNameMap<ClassKey> : (props: Props) => ClassNameMap<ClassKey>;
...
interface MergeClassesOption {
    ...
    Component?: React$1.ElementType | null | any;
}
...
declare class ServerStyleSheets$1 {
    ...
    collect(children: React$1.ReactNode): React$1.ReactElement<StylesProviderProps>;
    toString(): string;
    getStyleElement(props?: object): React$1.ReactElement;
}

type OptionsProps<Theme> = {
    name?: string;
} | WithStylesOptions<Theme>;
type Component = React$1.ElementType<any>;

declare function styled$1<Theme = Theme$1, Props extends {} = React$1.ComponentPropsWithoutRef<Component>>(Component: Component): (style: CreateCSSProperties<Props> | ((props: {
    theme: Theme;
} & Props) => CreateCSSProperties<Props>), options?: OptionsProps<Theme>) => React$1.ForwardRefExoticComponent<Omit<any, "ref"> & React$1.RefAttributes<any>>;

declare function StylesProvider$1(props: StylesProviderProps): React$1.JSX.Element;

declare function useThemes(): _mui_material.Theme;
...
declare function withStyles<StylesType extends Styles<any, any>, Options extends WithStylesOptions<ThemeOfStyles<StylesType>> = {}>(style: StylesType, options?: Options): PropInjector<WithStyles<StylesType, Options["withTheme"]>, StyledComponentProps<ClassKeyOfStyles<StylesType>> & PropsOfStyles<StylesType>>;

interface WithThemeCreatorOption<Theme = Theme$1> {
    defaultTheme?: Theme;
}
interface WithTheme<Theme = Theme$1> {
    theme: Theme;
}
...
declare function withTheme<C extends React$1.JSXElementConstructor<ConsistentWith<React$1.ComponentProps<C>, WithTheme<Theme>>>, Theme = Theme$1>(Component: C, option?: WithThemeCreatorOption<Theme>): React$1.JSXElementConstructor<DistributiveOmit<JSX.LibraryManagedAttributes<C, React$1.ComponentProps<C>>, keyof WithTheme<Theme>> & Partial<WithTheme<Theme>> & ThemedComponentProps>;

declare const createGenerateClassName: typeof createGenerateClassName$1;

declare const makeStyles: typeof makeStyles$1;
...
export { ServerStyleSheets, StylesProvider, createGenerateClassName, createStyles, getThemeProps, makeStyles, mergeClasses, propsToClassKey, styled, useThemes as useTheme, useThemeVariants, withStyles, withTheme };
